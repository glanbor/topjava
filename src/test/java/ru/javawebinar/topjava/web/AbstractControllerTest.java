...
public abstract class AbstractControllerTest {
    ...
    private String getMessage(String message) {
        return messageUtil.getMessage(message, MessageUtil.RU_LOCALE);
    }

    public ResultMatcher error(ErrorType type) {
        return jsonPath("$.type").value(type.name());
    }

    public ResultMatcher details(String message) {
        return jsonPath("$.details").value(getMessage(message));
    }
}
