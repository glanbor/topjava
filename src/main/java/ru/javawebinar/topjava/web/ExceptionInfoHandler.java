...
public class ExceptionInfoHandler {
    ...
    public static final String EXCEPTION_DUPLICATE_EMAIL = "email.duplicate";
    public static final String EXCEPTION_DUPLICATE_DATETIME = "mealDateTime.duplicate";

    private static final Map<String, String> EXCEPTIONS_MAP = Map.of(
    ...
    public ErrorInfo conflict(HttpServletRequest req, DataIntegrityViolationException e) {
        ...
        if (rootMessage != null) {
            ...
            Optional<Map.Entry<String, String>> entry = EXCEPTIONS_MAP.entrySet().stream()
                    .filter(x -> lowerCaseRootMessage.contains(x.getKey()))
                    .findAny();
            if (entry.isPresent()) {
